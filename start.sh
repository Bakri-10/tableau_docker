...
cat reg-info.json > '/home/centos/tableau-server-container-setup-tool-2022.3.1/reg-info.json'


cat setup-script > '/home/centos/tableau-server-container-setup-tool-2022.3.1/customer-files/setup-script'
cat env.txt > '/home/centos/tableau-server-container-setup-tool-2022.3.1/env.txt'
